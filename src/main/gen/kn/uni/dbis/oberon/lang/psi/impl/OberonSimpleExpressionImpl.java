...
public class OberonSimpleExpressionImpl extends ASTWrapperPsiElement implements OberonSimpleExpression {

  public OberonSimpleExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
