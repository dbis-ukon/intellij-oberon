...
public class OberonCaseImpl extends ASTWrapperPsiElement implements OberonCase {

  public OberonCaseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonLabelRange> getLabelRangeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonLabelRange.class);
  }
