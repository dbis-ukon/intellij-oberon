...
public class OberonTypeDeclarationImpl extends ASTWrapperPsiElement implements OberonTypeDeclaration {

  public OberonTypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
