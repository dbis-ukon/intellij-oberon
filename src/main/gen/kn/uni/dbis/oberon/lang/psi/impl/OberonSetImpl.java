...
public class OberonSetImpl extends ASTWrapperPsiElement implements OberonSet {

  public OberonSetImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonElement> getElementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonElement.class);
  }
