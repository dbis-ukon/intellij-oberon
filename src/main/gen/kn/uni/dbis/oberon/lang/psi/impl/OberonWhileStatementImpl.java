...
public class OberonWhileStatementImpl extends ASTWrapperPsiElement implements OberonWhileStatement {

  public OberonWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
