...
public class OberonConstDeclarationImpl extends ASTWrapperPsiElement implements OberonConstDeclaration {

  public OberonConstDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
