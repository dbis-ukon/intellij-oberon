...
public class OberonActualParametersImpl extends ASTWrapperPsiElement implements OberonActualParameters {

  public OberonActualParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
